...
// --- Stay Lit: Register user billing meta for REST + allow meta on user create/update ---
...
// --- Stay Lit: Show Installation Date & Warranty Registered on user profile ---
add_action('show_user_profile', 'staylit_show_warranty_user_fields');
add_action('edit_user_profile', 'staylit_show_warranty_user_fields');
function staylit_show_warranty_user_fields($user) { ?>
...
add_action('personal_options_update', 'staylit_save_warranty_user_fields');
add_action('edit_user_profile_update', 'staylit_save_warranty_user_fields');
function staylit_save_warranty_user_fields($user_id) {
